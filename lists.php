...
include("dbconfig.php");
	...
	$sql="SELECT * FROM computer where camount > 0 order by cpicture";
	//接收返回值
       ...
       <div class="nav-div" style="display: none;"> 
        <div class="navdiv_top"> 
			<div class="navdiv-right">
				...
				<p> <a href="type.php?ctype='轻薄本'">轻薄本系列</a></p>
				<p> <a href="type.php?ctype='游戏本'">游戏本系列</a></p>
				<p> <a href="type.php?ctype='商用本'">商用本系列</a></p>
				<p> <a href="type.php?ctype='二合一'">二合一系列</a></p>
				<p> <a href="type.php?ctype='超级本'">超级本系列</a></p>
			</div>
			<div class="navdiv-left">
                  <h3> NEW</h3>
                  <a href="detail.html"> <img width="118" height="110" src="images/computers/21.png" /></a>
                  <div class="more_cp">
                    <a href="detail.php?cid='100003671700
'">&gt; 了解该系列产品</a>
                  </div>
                </div>
      ...
      <div class="dr_choose"> 
       ...
       <div class="drcho_top"> 
        <ul class="drchoose_ul"> 
         <li class="choose_hover" id="ucser_all"><span>所有商品</span> </li> 
         <li id="ucser_forever"><span>轻薄本系列</span> </li> 
         <li id="ucser_myheart"><span>游戏本系列</span> </li> 
         <li id="ucser_swear"><span>商用本系列</span> </li> 
         <li id="ucser_justyou"><span>二合一系列</span> </li> 
         <li style="background-image:none" id="ucser_truelove"><span>超极本系列</span> </li> 
        </ul> 
       </div> 
      ...
      <ul class="buyit"> 
       ...
       <?php
		  ...
		  ?>
	       <li> 
	        <div class="by_top"> 
	         <a href="detail.php?cid='<?php echo $row['cid'] ?>'"></a> 
	         <div class="bything-one"> 
	          <img width="236px" height="236" src = "/images/computers/<?php echo $row['cpicture']?>" /> 
	         </div> 
	        ...
	        <div class="by_bottom"> 
	         <p> <a href="/darry_ring/78.html"><?php echo $row['ctype']." ".$row['cbrand'].' '.$row['cname'] ?></a></p> 

										...
										<table id="simple-table" class="table  table-bordered table-hover">
											<thead>
												<tr>
													...
													<th class="center col-md-1">商品编号</th>
													<th class="center col-md-1">商品名</th>
													<th class="center col-md-2">号码</th>
...
?>
											<tbody>	
												...
												<tr>
													<td class="center"><?php echo $orders['oid']; ?></td>
													<td class="center"><?php echo $orders['ocoid']; ?></td>
													<td class="center"><?php echo $orders['oconame']; ?></td>
													<td class="hidden-480 center"><?php echo $orders['ouiphone']; ?></td>
													<td class="hidden-480 center"><?php echo $orders['otime']; ?></td>
													<td class="center"><?php echo $orders['omoney']; ?></td>
														...
														<div class="row">
															...
															<div class="col-xs-12 col-md-8">
																<table id="simple-table" class="table  table-bordered table-hover">
																	<thead>
																		<tr>
																			<th class="center col-md-1" style="background-color: #ecdfdf;">商品编号</th>
																			...
																			<th class="center col-md-1" style="background-color: #ecdfdf;">数量</th>
																		</tr>
																	</thead>
																	...
																	<tbody>
																		<tr>
																			...
																			<td class="center">demon</td>
																			<td class="center">$9999</td>
																			<td class="hidden-480 center">demon</td>
																			<td class="center">demon</td>
																			<td class="hidden-480 center"> demon </td>
																		</tr>

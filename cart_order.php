								...
								<div class="shop_adress-qr">
										...
										<tbody>
											...
											?>
												<tr class="shop_adressqr-sec">
													<td class="shop_adress-shoop"><?php echo $cart['caconame'] ?></td>
													<td class="shop_adress-cz"><?php echo $cart['cacobrand'] ?></td>
													<td class="shop_adress-sc"><?php echo $cart['cacotype'] ?></td>
													<td class="shop_adress-kz"><?php echo $cart['cacoamount'] ?></td>
													<td class="shop_adress-pirce"><span style="font-family:微软雅黑">￥<?php echo $cart['camoney'] ?></span></td>
												</tr>
											<?php 
												}
											?>
									...
									<div class="shop_adress-zj">
										...
										<div class="fr">
											...
											<span>件商品</span>
											<span>应付金额：</span>
											<i style="font-family:微软雅黑" class="fw_bold">￥<?php echo $summoney; ?></i>
										</div>
									</div>
									<!--总计-->
									<!--最后一块-->
									<div class="shop_adress-last">
										...
										<div onClick="submitOrder();" class="shop_adress-tjdd fr">
											<div class="bt1 fr">
												<a href="cart_order_success.php?summoney=<?php echo $summoney; ?>"><span>立即提交订单</span></a>
											</div>
										</div>
									</div>
									<!--最后一块end-->
